...
public class CodegenPreviewRespVO {
    ...
    @Schema(description = "文件路径", requiredMode = Schema.RequiredMode.REQUIRED, example = "java/cn/iocoder/jeelowcode/adminserver/modules/system/controller/test/SysTestDemoController.java")
