...
import com.jeelowcode.service.system.controller.vo.tenant.packages.TenantPackageRespVO;
import com.jeelowcode.service.system.controller.vo.tenant.packages.TenantPackageSaveReqVO;
import com.jeelowcode.service.system.controller.vo.tenant.packages.TenantPackageSimpleRespVO;
...
public class TenantPackageController {
    ...
    @PostMapping("/create")
    @Operation(tags = "租户管理",summary = "创建租户套餐")
    ...
    @PutMapping("/update")
    @Operation(tags = "租户管理",summary = "更新租户套餐")
    ...
    @Operation(tags = "租户管理",summary = "删除租户套餐")
    ...
    @GetMapping("/get")
    @Operation(tags = "租户管理",summary = "获得租户套餐")
    ...
    @GetMapping("/page")
    @Operation(tags = "租户管理",summary = "获得租户套餐分页")
    @PreAuthorize("@ss.hasPermission('system:tenant-package:query')")
    ...
    @Operation(tags = "租户管理",summary = "获取租户套餐精简信息列表", description = "只包含被开启的租户套餐，主要用于前端的下拉选项")
