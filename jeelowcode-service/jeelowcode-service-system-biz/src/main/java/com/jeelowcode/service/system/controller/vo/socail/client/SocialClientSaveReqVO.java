package com.jeelowcode.service.system.controller.vo.socail.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "jeelowcode商城")
