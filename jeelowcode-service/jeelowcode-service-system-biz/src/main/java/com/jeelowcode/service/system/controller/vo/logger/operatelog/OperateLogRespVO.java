package com.jeelowcode.service.system.controller.vo.logger.operatelog;
...
public class OperateLogRespVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.iocoder.jeelowcode.adminserver.UserController.save(...)")
