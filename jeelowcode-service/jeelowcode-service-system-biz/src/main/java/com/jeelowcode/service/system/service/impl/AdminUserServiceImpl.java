...
import com.jeelowcode.service.system.controller.vo.user.user.UserImportExcelVO;
import com.jeelowcode.service.system.controller.vo.user.user.UserImportRespVO;
import com.jeelowcode.service.system.controller.vo.user.user.UserPageReqVO;
...
import com.jeelowcode.tool.framework.permission.core.util.DataPermissionUtils;
import com.jeelowcode.service.infra.api.FileApi;
import com.jeelowcode.service.system.entity.DeptDO;
import com.jeelowcode.service.system.entity.UserPostDO;
import com.jeelowcode.service.system.entity.AdminUserDO;
import com.jeelowcode.service.system.mapper.UserPostMapper;
...
public class AdminUserServiceImpl implements IAdminUserService {
    ...
    public Long createUser(UserSaveReqVO createReqVO) {
        ...
        tenantService.handleTenantInfo(tenant -> {
            ...
            if (count >= tenant.getAccountCount()) {
                throw exception(ErrorCodeConstants.USER_COUNT_MAX, tenant.getAccountCount());
            }
        });
        // 校验正确性
    ...
    public void validateUserList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!CommonStatusEnum.ENABLE.getStatus().equals(user.getStatus())) {
                throw exception(ErrorCodeConstants.USER_IS_DISABLE, user.getNickname());
            }
        });
    }
    ...
    void validateEmailUnique(Long id, String email) {
        ...
        // 如果 id 为空，说明不用比较是否为相同 id 的用户
        if (id == null) {
            throw exception(ErrorCodeConstants.USER_EMAIL_EXISTS);
        }
        if (!user.getId().equals(id)) {
            throw exception(ErrorCodeConstants.USER_EMAIL_EXISTS);
        }
