package com.jeelowcode.service.system.controller.vo.sms.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "jeelowcode")
