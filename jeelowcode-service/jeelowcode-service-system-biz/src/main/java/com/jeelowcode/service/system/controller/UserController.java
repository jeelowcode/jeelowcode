...
import com.jeelowcode.service.system.controller.vo.user.user.*;
...
import com.jeelowcode.service.system.enums.SexEnum;
...
public class UserController {
    ...
    @PostMapping("/create")
    @Operation(tags = "用户管理",summary = "新增用户")
    ...
    @PutMapping("update")
    @Operation(tags = "用户管理",summary = "修改用户")
    ...
    @Operation(tags = "用户管理",summary = "删除用户")
    ...
    @Operation(tags = "用户管理",summary = "重置用户密码")
    ...
    @Operation(tags = "用户管理",summary = "修改用户状态")
    @PreAuthorize("@ss.hasPermission('system:user:update')")
    ...
    @GetMapping("/page")
    @Operation(tags = "用户管理",summary = "获得用户分页列表")
    ...
    @Operation(tags = "用户管理",summary = "获取用户精简信息列表", description = "只包含被开启的用户，主要用于前端的下拉选项")
    ...
    @GetMapping("/get")
    @Operation(tags = "用户管理",summary = "获得用户详情")
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    ...
    @GetMapping("/export")
    @Operation(tags = "用户管理",summary = "导出用户")
    ...
    @Operation(tags = "用户管理",summary = "获得导入用户模板")
    ...
    @PostMapping("/import")
    @Operation(tags = "用户管理",summary = "导入用户")
    @Parameters({
