...
import com.jeelowcode.service.system.controller.vo.permission.role.RoleSaveReqVO;
...
import com.jeelowcode.service.system.config.handler.TenantInfoHandler;
import com.jeelowcode.service.system.config.handler.TenantMenuHandler;
...
import com.jeelowcode.service.system.config.convert.tenant.TenantConvert;
...
import com.jeelowcode.service.system.mapper.TenantMapper;
import com.jeelowcode.service.system.enums.RoleCodeEnum;
import com.jeelowcode.service.system.enums.RoleTypeEnum;
...
import static com.jeelowcode.service.system.constant.ErrorCodeConstants.*;
/**
 * 租户 Service 实现类
 *
 * @author 芋道源码
...
public class TenantServiceImpl implements ITenantService {
    ...
    private void validTenantNameDuplicate(String name, Long id) {
        ...
        if (id == null) {
            throw ServiceExceptionUtil.exception(TENANT_NAME_DUPLICATE, name);
        }
    ...
    private void validTenantWebsiteDuplicate(String website, Long id) {
        ...
        // 如果 id 为空，说明不用比较是否为相同名字的租户
        if (id == null) {
            throw ServiceExceptionUtil.exception(TENANT_WEBSITE_DUPLICATE, website);
        }
        if (!tenant.getId().equals(id)) {
            throw ServiceExceptionUtil.exception(TENANT_WEBSITE_DUPLICATE, website);
        }
    ...
    private TenantDO validateUpdateTenant(Long id) {
        ...
        if (isSystemTenant(tenant)) {
            throw ServiceExceptionUtil.exception(TENANT_CAN_NOT_UPDATE_SYSTEM);
        }
        return tenant;
    }
