package com.jeelowcode.tool.framework.web.core.handler;

import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.map.MapUtil;
import com.jeelowcode.tool.framework.apilog.core.service.ApiErrorLog;
...
import static com.jeelowcode.tool.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    private CommonResult<?> handleTableNotExists(Throwable ex) {
        ...
        if (message.contains("bpm_")) {
            log.error("[工作流模块 表结构未导入");
            return CommonResult.error(NOT_IMPLEMENTED.getCode(),
                    "[工作流模块 jeelowcode-service-bpm - 表结构未导入][参考 https://doc.iocoder.cn/bpm/ 开启]");
        }
