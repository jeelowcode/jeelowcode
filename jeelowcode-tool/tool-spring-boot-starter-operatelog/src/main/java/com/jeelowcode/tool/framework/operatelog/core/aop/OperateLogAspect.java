package com.jeelowcode.tool.framework.operatelog.core.aop;
...
import com.jeelowcode.tool.framework.operatelog.core.service.OperateLog;
...
import static com.jeelowcode.tool.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.jeelowcode.tool.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.jeelowcode.tool.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.jeelowcode.tool.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.jeelowcode.tool.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.jeelowcode.tool.framework.operatelog.core.annotations.OperateLog operateLog,
    ...
    private static boolean isLogEnable(ProceedingJoinPoint joinPoint,
        ...
        boolean flag= obtainFirstLogRequestMethod(obtainRequestMethod(joinPoint)) != null;
        return flag;
    }
